...
test( "Recognizing audio", function() {
    ...
    equal(segmentation.get(4).end, 144);
    equal(segmentation.get(5).word, "LINUX");
    equal(segmentation.get(5).start, 145);
    equal(segmentation.get(5).end, 201);
    equal(segmentation.get(6).word, "IS");
    equal(segmentation.get(6).start, 202);
    equal(segmentation.get(6).end, 214);
    equal(segmentation.get(7).word, "GREAT");
    equal(segmentation.get(7).start, 215);
    equal(segmentation.get(7).end, 273);
    equal(segmentation.get(8).word, "<sil>");
    equal(segmentation.get(8).start, 274);
    equal(segmentation.get(8).end, 291);
});
